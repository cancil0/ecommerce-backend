...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entities.Concrete.Carousel", b =>
                {
                    ...
                    b.Property<string>("LinkToNavigate")
                        .IsRequired()
                        .HasColumnType("varchar")
                    ...
                    b.ToTable("carousel", "entity");

                    b.HasComment("Holds Home Page's carousel");
                });
            ...
            modelBuilder.Entity("Entities.Concrete.Merchant", b =>
                {
                    ...
                    b.Property<decimal>("FeedbackCount")
                        .HasColumnType("numeric(20,0)")
                    ...
                    b.Property<decimal>("RegistrationNo")
                        .HasColumnType("numeric(20,0)")
            ...
            modelBuilder.Entity("Entities.Concrete.Notification", b =>
                {
                    ...
                    b.ToTable("Notification", t => t.ExcludeFromMigrations());
                });
            ...
            modelBuilder.Entity("Entities.Concrete.ProductDetail", b =>
                {
                    ...
                    b.Property<decimal>("PurchaseCount")
                        .HasMaxLength(250)
                        .HasColumnType("numeric(20,0)")
            ...
            modelBuilder.Entity("Entities.Concrete.UserDefault", b =>
                {
                    b.Property<Guid>("UserDefaultId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("UserDefaultId");

                    b.HasIndex("UserId")
                        .IsUnique();

                    b.ToTable("userdefault", "entity");
                });
            ...
            modelBuilder.Entity("Entities.Concrete.UserDefault", b =>
                {
                    b.HasOne("Entities.Concrete.User", "User")
                        .WithOne("UserDefault")
                        .HasForeignKey("Entities.Concrete.UserDefault", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
